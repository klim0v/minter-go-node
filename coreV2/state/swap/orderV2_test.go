...
func TestPair_LoadOrders_bag13748182(t *testing.T) {
	...
	t.Log(order25155.sortPrice().Text('e', 38))
	...
	t.Log(order25158.sortPrice().Text('e', 38))
	...
	t.Log(order25235.sortPrice().Text('e', 38))
	...
	t.Log(order25557.sortPrice().Text('e', 38))
